...
from model.GhostDensNet import GhostDensNetFPN
...
"""
    CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.launch --nproc_per_node=1 --use_env train-fpn.py   
...
def main(args):
    ...
    # ========================================= model ===========================
    model = GhostDensNetFPN().to(device)
